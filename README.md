...
| [rover_stack/](rover_stack/) | Example robot integration using the LD06 library |
...
`rover_stack/` is an example of using the LD06 library on a robot: an ESP32 bot streams LD06 telemetry through an ESP-NOW controller bridge, and the host tools can drive the bot and view live scan data.
